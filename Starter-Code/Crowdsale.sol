...
contract PupperCoinSaleDeployer {
        ...
        public
    {
        ...
        //PupperCoinSale token_sale = new PupperCoinSale(10, wallet, token, goal, now, now + 24 weeks);
        //token_sale_address = address(token_sale);
        PupperCoinSale pupper_sale = new PupperCoinSale(10, wallet, token, goal, now, now + 24 weeks);
